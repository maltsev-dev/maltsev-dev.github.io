...
I don't have deep experience with microcontrollers, and I only have a superficial knowledge of machine learning. This sounds like a complex technical challenge to me.

2. I want to improve my Rust skills.
I want to use Rust as the primary language for developing firmware and the entire server side. I've long liked it, and after several successfully implemented projects using it, I've never had to question what to use for firmware.
